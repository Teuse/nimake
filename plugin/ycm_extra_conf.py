  ...
  if IsHeaderFile(filename):
    ...
    for extension in SOURCE_EXTENSIONS:
      ...
      if not os.path.exists(replacement_file):
        replacement_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), "src/MASCommon/app/Application.cpp")
...
def FlagsForFile(filename, **kwargs):
  if database:
    ...
    compilation_info = GetCompilationInfoForFile(str(filename))
